...
<div style="margin-bottom: 12px; text-align: right;">
               ...
               <div class="field-row">
                ...
                <div class="field-row">
                  ...
                  <label class="field"><span>Shoot Location / Venue Address *</span><input id="b_location" type="text" required value="Studio Space, Noida Sector 46 (home studio)/ Outdoor Delhi NCR" placeholder="e.g. Studio Space, Noida Sector 46 (home studio)/ Outdoor Delhi NCR" /></label>
                </div>
...
if ('serviceWorker' in navigator && (window.location.protocol === 'https:' || window.location.hostname === 'localhost')) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('/sw.js?v=224').catch(() => {});
  });
}
